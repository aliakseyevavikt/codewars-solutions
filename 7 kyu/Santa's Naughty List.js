...
Description:
Christmas is coming, and Santa has a long list to go through, to find who deserves presents for the big day. Go through
a list of children, and return a list containing every child who appeared on Santa's list. Do not add any child more
...
function findChildren(santasList, children) {
    ...
    return santasList.filter((k, ind) => ind === santasList.indexOf(k)).sort();
}