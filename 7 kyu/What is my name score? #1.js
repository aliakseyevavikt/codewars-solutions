...
In accordance to the above alpha object, the name Mary Jane will have a name score of
 20 => M=3 + a=1 + r=4 + y=5 + J=2 + a=1 + n=3 + e=1
 */

function nameScore(name) {
    let alpha = {'ABCDE': 1, 'FGHIJ': 2, 'KLMNO': 3, 'PQRST': 4, 'UVWXY': 5}  //'Z' is ignored
    let sum = 0;
