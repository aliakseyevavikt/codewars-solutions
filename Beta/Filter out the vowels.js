...
Description:
Write a function, vowelFilter, that takes an array of strings as an argument and returns a filtered array containing
 the same elements but with the 'vowels' removed.
...
The elements in the returned array should be in the same order as in the initial array passed to your function,
 albeit with the 'vowels' removed. Note that all of the strings will be in the same case as those provided,
